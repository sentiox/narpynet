...
// src/harpynet/methods/custom/getConfigSections.ts
async function getConfigSections() {
  return uci.load("harpynet").then(() => uci.sections("harpynet"));
}

// src/harpynet/methods/shell/callBaseMethod.ts
async function callBaseMethod(method, args = [], command = "/usr/bin/harpynet") {
...
// src/harpynet/methods/shell/index.ts
...
// src/harpynet/methods/custom/getDashboardSections.ts
...
// src/harpynet/methods/custom/getClashApiSecret.ts
...
// src/harpynet/methods/custom/index.ts
...
// src/harpynet/methods/fakeip/getFakeIpCheck.ts
...
// src/harpynet/methods/fakeip/getIpCheck.ts
...
// src/harpynet/methods/fakeip/index.ts
var RemoteFakeIPMethods = {
  getFakeIpCheck,
  getIpCheck
};

// src/harpynet/services/tab.service.ts
...
// src/harpynet/tabs/diagnostic/helpers/getCheckTitle.ts
function getCheckTitle(name) {
  return `${name} ${_("checks")}`;
}

// src/harpynet/tabs/diagnostic/checks/contstants.ts
...
// src/harpynet/tabs/diagnostic/diagnostic.store.ts
...
// src/harpynet/services/store.service.ts
...
// src/harpynet/services/logger.service.ts
var Logger = class {
  constructor() {
    this.logs = [];
...
// src/harpynet/services/harpynetLogWatcher.service.ts
...
// src/harpynet/services/core.service.ts
...
// src/harpynet/services/socket.service.ts
...
// src/harpynet/tabs/dashboard/partials/renderSections.ts
...
// src/harpynet/tabs/dashboard/partials/renderWidget.ts
...
// src/harpynet/tabs/dashboard/render.ts
function render() {
  return E(
    "div",
    {
...
// src/harpynet/fetchers/fetchServicesInfo.ts
...
// src/harpynet/tabs/dashboard/initController.ts
...
// src/harpynet/tabs/dashboard/styles.ts
var styles = `
...
// src/harpynet/tabs/dashboard/index.ts
var DashboardTab = {
  render,
  initController,
  styles
...
// src/harpynet/tabs/diagnostic/renderDiagnostic.ts
function render2() {
...
// src/harpynet/tabs/diagnostic/checks/updateCheckStore.ts
...
// src/harpynet/tabs/diagnostic/helpers/getMeta.ts
...
// src/harpynet/tabs/diagnostic/checks/runDnsCheck.ts
...
// src/harpynet/tabs/diagnostic/checks/runSingBoxCheck.ts
...
// src/harpynet/tabs/diagnostic/checks/runNftCheck.ts
...
// src/harpynet/tabs/diagnostic/checks/runFakeIPCheck.ts
...
// src/harpynet/tabs/diagnostic/partials/renderAvailableActions.ts
...
// src/harpynet/tabs/diagnostic/partials/renderCheckSection.ts
...
// src/harpynet/tabs/diagnostic/partials/renderRunAction.ts
...
// src/harpynet/tabs/diagnostic/partials/renderSystemInfo.ts
...
// src/harpynet/tabs/diagnostic/partials/renderWikiDisclaimer.ts
...
// src/harpynet/tabs/diagnostic/checks/runSectionsCheck.ts
...
// src/harpynet/tabs/diagnostic/helpers/getHarpyNetVersionRow.ts
...
// src/harpynet/tabs/diagnostic/initController.ts
...
// src/harpynet/tabs/diagnostic/styles.ts
var styles4 = `
...
// src/harpynet/tabs/diagnostic/index.ts
var DiagnosticTab = {
  render: render2,
