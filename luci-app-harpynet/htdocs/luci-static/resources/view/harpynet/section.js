...
function createSectionContent(section) {
  ...
  o = section.option(
    ...
    "subscription_url",
    _("Subscription URL"),
    _("Raw/base64 proxy URI subscription. HarpyNet sends HWID headers for Remnawave-compatible panels.")
  );
  ...
  o = section.option(
    ...
    "subscription_mode",
    _("Subscription Mode"),
    _("Selector keeps manual node choice. URLTest also creates a fastest-node group.")
  );
  o.value("selector", _("Selector"));
  o.value("urltest", _("URLTest"));
  o.default = "selector";
