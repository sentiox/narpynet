...
export const HARPYNET_LUCI_APP_VERSION = '__COMPILED_VERSION_VARIABLE__';
export const FAKEIP_CHECK_DOMAIN = 'fakeip.harpynet.fyi';
export const IP_CHECK_DOMAIN = 'ip.harpynet.fyi';
