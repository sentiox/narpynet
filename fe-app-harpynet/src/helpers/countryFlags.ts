...
export function inferCountryCode(name?: string) {
...
export function stripCountryPrefix(name: string, country?: string) {
  let value = `${name || ''}`.trim();
...
export function renderCountryFlag(country?: string, label?: string) {
