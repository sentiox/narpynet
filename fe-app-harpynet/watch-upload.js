...
const syncDirs = [
  {
    local: path.resolve(process.env.LOCAL_DIR_FE ?? '../luci-app-harpynet/htdocs/luci-static/resources/view/harpynet'),
    remote: process.env.REMOTE_DIR_FE ?? '/www/luci-static/resources/view/harpynet',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_BIN ?? '../harpynet/files/usr/bin/'),
    remote: process.env.REMOTE_DIR_BIN ?? '/usr/bin/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_LIB ?? '../harpynet/files/usr/lib/'),
    remote: process.env.REMOTE_DIR_LIB ?? '/usr/lib/harpynet/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_INIT ?? '../harpynet/files/etc/init.d/'),
