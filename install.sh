...
REPO="https://api.github.com/repos/sentiox/narpynet/releases/latest"
...
update_config() {
    ...
    printf "\033[48;5;196m\033[1m║ Подробности: https://github.com/sentiox/narpynet                     ║\033[0m\n"
    ...
    printf "\033[48;5;196m\033[1m║ Details: https://github.com/sentiox/narpynet                         ║\033[0m\n"
    ...
    while true; do
            ...
            yes|y|Y)
                mv /etc/config/harpynet /etc/config/harpynet-070
                wget -O /etc/config/harpynet https://raw.githubusercontent.com/sentiox/narpynet/refs/heads/main/harpynet/files/etc/config/harpynet
                msg "HarpyNet config has been reset to default. Your old config saved in /etc/config/harpynet-070"
                break
                ;;
            *)
                msg "Exit"
...
main() {
    ...
    if command -v curl >/dev/null 2>&1; then
        check_response=$(curl -s "https://api.github.com/repos/sentiox/narpynet/releases/latest")
...
check_system() {
    ...
    if [ "$openwrt_version" = "23" ]; then
        ...
        msg "Подробности: https://github.com/sentiox/narpynet/docs/install/#%d1%83%d1%81%d1%82%d0%b0%d0%bd%d0%be%d0%b2%d0%ba%d0%b0-%d0%bd%d0%b0-2305"
        exit 1
    fi
